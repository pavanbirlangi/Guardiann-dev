...
INSERT INTO categories (id, name, slug, description, icon_url, subcategories, display_order, is_active)
VALUES 
    ('11111111-1111-1111-1111-111111111111', 'Schools', 'schools', 'Primary and secondary educational institutions', 'school-icon.png', ARRAY['Primary', 'Middle', 'High'], 1, true),
    ('22222222-2222-2222-2222-222222222222', 'Colleges', 'colleges', 'Higher education institutions', 'college-icon.png', ARRAY['Engineering', 'Medical', 'Arts'], 2, true),
    ('33333333-3333-3333-3333-333333333333', 'Coaching Centers', 'coaching', 'Specialized training and coaching centers', 'coaching-icon.png', ARRAY['JEE', 'NEET', 'Foundation'], 3, true),
    ('44444444-4444-4444-4444-444444444444', 'Postgraduate Colleges', 'pg-colleges', 'Advanced degree institutions', 'pg-icon.png', ARRAY['MBA', 'PhD', 'Executive'], 4, true)
